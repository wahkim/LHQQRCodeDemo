...
@protocol RHScanNativeDelegate <NSObject>
...
// @return RichScanNative的实例
// */
//- (instancetype)initWithPreView:(UIView*)preView ObjectType:(NSArray*)objType delegate:(id<RHScanNativeDelegate>)delegate;
...
@property (nonatomic, weak) id <RHScanNativeDelegate> delegate;
